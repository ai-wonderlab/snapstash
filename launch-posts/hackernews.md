...
snapstash adds two shortcuts: Cmd+Option+S (full screen) and Cmd+Option+A (area select). Both save to ~/Desktop/screenshots/ AND copy to clipboard. Simultaneously.
